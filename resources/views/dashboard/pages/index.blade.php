    ...
    @section('content')
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Ma Liste de livres</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($books as $book)
                                @if ($book->teacher_id === Auth::user()->id)
                                    <tr>
                                        <td><img src="{{ asset($book->image ?? 'assets/images/digital.jpg') }}"
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item"
                                                        href="/books/{{ $book->id }}/edit">Modifier</a>
                                                    <a class="dropdown-item"
                                                        href="/books/{{ $book->id }}/delete">Supprimer</a>
