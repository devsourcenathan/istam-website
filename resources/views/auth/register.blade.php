                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            <label for="matriculate">Matricule</label>
                                            <input id="matriculate" type="text" class="form-control"
                                                name="matriculate" required :value="old('matriculate')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            <label for="password2" class="d-block">Confirmation du mot de
                                                passe</label>
